...
test.describe('API challenges', () => {
  ...
  test("02 Get the list of challenges @API_positive", async ({ api, challengerToken }) => {
  ...
  test("03 Get todos 200 OK @API_positive", async ({ api, challengerToken }) => {
  ...
  test("05 Get id of todos 200 OK  @API_positive", async ({ api, challengerToken }) => {
  ...
  test("07 Get todos with filter DONE 200 OK @API_positive", async ({ api, challengerToken }) => {
  ...
  test("08 Head todos 200 OK  @API_positive", async ({ api, challengerToken }) => {
  ...
  test("09 Post/create todo 201 OK @API_positive", async ({ api, challengerToken }) => {
    const todoBuilder = new TodoBuilder()
      .addTitle()
      .addStatus(true)
      .addDescription()
  ...
  test("34 Get challenger guid (existing X-CHALLENGER) @API_positive", async ({ api, challengerToken }) => {
  ...
  test("35 Put challenger guid RESTORE to memory @API_positive", async ({ api, challengerToken }) => {
    let response = await api.challengerService.get(challengerToken, challengerToken);
    let progressData = await response.json();
